...
$('#send_register').on('click', function () { //顧客登録画面内の登録ボタンをクリック時
    ...
    $.ajax({
        url: '<?php echo base_url(); ?>Cl_total_list/insert_total_data',
        type: 'POST',
        dataType: "text",
        processData: false,
        contentType: false,
...
function kind_group_delete() {
    ...
    $.ajax({
        url: "<?php echo base_url(); ?>Cl_total_list/delete_kind_group",
        type: "POST",
        data: param,
    }).done(function (data) {
        if (data == 1) {
...
$(function () {
    ...
    $('#group_register').on('click', function () {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>Cl_total_list/insert_kind_group',
            type: 'POST',
            data: param
        })
            .done(function (data, textStatus, jqXHR) {
    ...
    $('#register4').on("click", function () { //更新ボタン
        ...
        // console.log(column);
        $.ajax({
            url: '<?php echo base_url(); ?>cl_total_list/get_total_all_data',
            type: 'POST',
            data: {
                id: pet_id
            }
...
$("#sendUpdateData").on("click", function () {
    ...
    $.ajax({
        url: '<?php echo base_url(); ?>Cl_total_list/update_total_data',
        type: 'POST',
        processData: false,
        contentType: false,
        data: fd
