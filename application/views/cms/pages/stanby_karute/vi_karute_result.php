                ...
                <div class="body">
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p><?php  if($karute["pet_animal_gender"] === 1 ){echo 'オス';}else if($karute["pet_animal_gender"] === 2){echo 'メス';}else{ echo 'その他';} ?>
                            </p>
                            <b>
                                <h4>去勢
                            </b></h4>
                            ...
                            <a href="/Karte_history/"><input type="button" value="カルテ入力する"></a>
                        </div>
                    </div>
                </div>
            </div>
