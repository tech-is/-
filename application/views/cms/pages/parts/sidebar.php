...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="user-info">
        ...
        <div class="info-container">
            <div id="account_name" class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $_SESSION['name'] ?>様</div>
            <div id="account_email" class="email"><?php echo $_SESSION['email'] ?></div>
