                ...
                <form id="sign_up" method="POST">
                    <div class="msg">新規本登録画面</div>
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="text" class="form-control" name="name[0]" placeholder="苗字" required autofocus>
                            </div>
                            <div class="form-line">
                                <input type="text" class="form-control" name="name[1]" placeholder="名前" required>
                            </div>
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">
                            ...
                            <div class="form-line">
                                <input type="text" class="form-control" name="kana[0]" placeholder="カナ苗字" required autofocus>
                            </div>
                            <div class="form-line">
                                <input type="text" class="form-control" name="kana[1]" placeholder="カナ名前" required>
                            </div>
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="text" class="form-control" name="zip_adress[0]" placeholder="都道府県" required>
                            </div>
                            <div class="form-line">
                                <input type="text" class="form-control" name="zip_adress[1]" placeholder="市町村" required>
                            </div>
                            <div class="form-line">
                                <input type="text" class="form-control" name="zip_adress[2]" placeholder="町域名" required>
                            </div>
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="password" class="form-control" name="confirm" minlength="6" placeholder="確認用パスワード" required>
                            </div>
                        </div>
