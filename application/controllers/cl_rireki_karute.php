...
class Cl_rireki_karute extends CI_Controller
{
    ...
    {
            $data["list"] = $this->rireki_karute_total_list();
    ...
    //一覧取得
    private function rireki_karute_total_list()
    {
        $shop_id = $_SESSION["shop_id"];
        return $this->Mdl_total_list->m_rireki_karute_total_list($shop_id);
    }
